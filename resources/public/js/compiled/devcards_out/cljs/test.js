...
var args33398 = [];
var len__25897__auto___33402 = arguments.length;
var i__25898__auto___33403 = (0);
while(true){
if((i__25898__auto___33403 < len__25897__auto___33402)){
args33398.push((arguments[i__25898__auto___33403]));

var G__33404 = (i__25898__auto___33403 + (1));
i__25898__auto___33403 = G__33404;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args33398.length)].join('')));
...
var G__33401 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__33401,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__33401;
}
});
...
var or__24822__auto__ = cljs.test._STAR_current_env_STAR_;
...
var len__25897__auto___33409 = arguments.length;
var i__25898__auto___33410 = (0);
while(true){
if((i__25898__auto___33410 < len__25897__auto___33409)){
args__25904__auto__.push((arguments[i__25898__auto___33410]));

var G__33411 = (i__25898__auto___33410 + (1));
i__25898__auto___33410 = G__33411;
continue;
} else {
}
break;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__25905__auto__);
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq33406){
var G__33407 = cljs.core.first.call(null,seq33406);
var seq33406__$1 = cljs.core.next.call(null,seq33406);
var G__33408 = cljs.core.first.call(null,seq33406__$1);
var seq33406__$2 = cljs.core.next.call(null,seq33406__$1);
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__33407,G__33408,seq33406__$2);
});
...
var file = cljs.core.get.call(null,map__33415__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__33415__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__33415__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__33415,map__33415__$1,file,line,column){
return (function (p1__33412_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__33412_SHARP_));
});})(map__33415,map__33415__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__25747__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__25747__auto__,prefer_table__25748__auto__,method_cache__25749__auto__,cached_hierarchy__25750__auto__,hierarchy__25751__auto__){
return (function (m){
...
var formatter_fn = (function (){var or__24822__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__24822__auto__)){
return or__24822__auto__;
} else {
...
var temp__4657__auto___33417 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___33417)){
var message_33418 = temp__4657__auto___33417;
cljs.core.println.call(null,message_33418);
} else {
}
...
var temp__4657__auto___33419 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___33419)){
var message_33420 = temp__4657__auto___33419;
cljs.core.println.call(null,message_33420);
} else {
}
...
var temp__4655__auto__ = (function (){var and__24810__auto__ = typeof exception.stack === 'string';
if(and__24810__auto__){
var G__33430 = exception.stack;
var G__33430__$1 = (((G__33430 == null))?null:clojure.string.split_lines.call(null,G__33430));
var G__33430__$2 = (((G__33430__$1 == null))?null:cljs.core.get.call(null,G__33430__$1,depth));
if((G__33430__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__33430__$2);
}
} else {
...
var vec__33431 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__33431,(0),null);
var column = cljs.core.nth.call(null,vec__33431,(1),null);
var vec__33434 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__33434,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__33434,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__33434,(2),null);
...
var m__$1 = (function (){var G__33438 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__33438) {
case "fail":
...
var G__33444 = (function (){var G__33443 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__33443);
} else {
return G__33443;
}
})();
...
return cljs.core.vary_meta.call(null,G__33446,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e33449){var e = e33449;
var G__33450 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__33450) {
...
var vec__33455 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__33455,(0),null);
var types = vec__33455;
...
return cljs.core.map.call(null,(function (p__33467){
var vec__33468 = p__33467;
var ns = cljs.core.nth.call(null,vec__33468,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__33468,(1),null);
return ((function (vec__33468,ns,vars__$1){
return (function (){
...
var G__33471 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__33471) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__33471,env,once_fixtures,each_fixtures,vec__33468,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__33471,env,once_fixtures,each_fixtures,vec__33468,ns,vars__$1){
return (function (){
var seq__33472 = cljs.core.seq.call(null,vars__$1);
var chunk__33473 = null;
var count__33474 = (0);
var i__33475 = (0);
while(true){
if((i__33475 < count__33474)){
var v = cljs.core._nth.call(null,chunk__33473,i__33475);
var temp__4657__auto___33477 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___33477)){
var t_33478 = temp__4657__auto___33477;
each_fixture_fn.call(null,((function (seq__33472,chunk__33473,count__33474,i__33475,t_33478,temp__4657__auto___33477,v,each_fixture_fn,G__33471,env,once_fixtures,each_fixtures,vec__33468,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_33478)));
});})(seq__33472,chunk__33473,count__33474,i__33475,t_33478,temp__4657__auto___33477,v,each_fixture_fn,G__33471,env,once_fixtures,each_fixtures,vec__33468,ns,vars__$1))
);
} else {
}

var G__33479 = seq__33472;
var G__33480 = chunk__33473;
var G__33481 = count__33474;
var G__33482 = (i__33475 + (1));
seq__33472 = G__33479;
chunk__33473 = G__33480;
count__33474 = G__33481;
i__33475 = G__33482;
continue;
} else {
var temp__4657__auto__ = cljs.core.seq.call(null,seq__33472);
if(temp__4657__auto__){
var seq__33472__$1 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__33472__$1)){
var c__25633__auto__ = cljs.core.chunk_first.call(null,seq__33472__$1);
var G__33483 = cljs.core.chunk_rest.call(null,seq__33472__$1);
var G__33484 = c__25633__auto__;
var G__33485 = cljs.core.count.call(null,c__25633__auto__);
var G__33486 = (0);
seq__33472 = G__33483;
chunk__33473 = G__33484;
count__33474 = G__33485;
i__33475 = G__33486;
continue;
} else {
var v = cljs.core.first.call(null,seq__33472__$1);
var temp__4657__auto___33487__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___33487__$1)){
var t_33488 = temp__4657__auto___33487__$1;
each_fixture_fn.call(null,((function (seq__33472,chunk__33473,count__33474,i__33475,t_33488,temp__4657__auto___33487__$1,v,seq__33472__$1,temp__4657__auto__,each_fixture_fn,G__33471,env,once_fixtures,each_fixtures,vec__33468,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_33488)));
});})(seq__33472,chunk__33473,count__33474,i__33475,t_33488,temp__4657__auto___33487__$1,v,seq__33472__$1,temp__4657__auto__,each_fixture_fn,G__33471,env,once_fixtures,each_fixtures,vec__33468,ns,vars__$1))
);
} else {
}

var G__33489 = cljs.core.next.call(null,seq__33472__$1);
var G__33490 = null;
var G__33491 = (0);
var G__33492 = (0);
seq__33472 = G__33489;
chunk__33473 = G__33490;
count__33474 = G__33491;
i__33475 = G__33492;
continue;
}
} else {
...
});})(each_fixture_fn,G__33471,env,once_fixtures,each_fixtures,vec__33468,ns,vars__$1))
);
});})(each_fixture_fn,G__33471,env,once_fixtures,each_fixtures,vec__33468,ns,vars__$1))
], null);
...
//# sourceMappingURL=test.js.map?rel=1482768544937