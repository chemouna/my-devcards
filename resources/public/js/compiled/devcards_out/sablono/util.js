...
var m__25486__auto__ = (sablono.util.to_str[goog.typeOf(x__25485__auto__)]);
if(!((m__25486__auto__ == null))){
return m__25486__auto__.call(null,x);
} else {
var m__25486__auto____$1 = (sablono.util.to_str["_"]);
...
var x__25485__auto__ = (((x == null))?null:x);
var m__25486__auto__ = (sablono.util.to_uri[goog.typeOf(x__25485__auto__)]);
if(!((m__25486__auto__ == null))){
return m__25486__auto__.call(null,x);
} else {
var m__25486__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__25486__auto____$1 == null))){
return m__25486__auto____$1.call(null,x);
} else {
...
var len__25897__auto___26208 = arguments.length;
var i__25898__auto___26209 = (0);
while(true){
if((i__25898__auto___26209 < len__25897__auto___26208)){
args__25904__auto__.push((arguments[i__25898__auto___26209]));

var G__26210 = (i__25898__auto___26209 + (1));
i__25898__auto___26209 = G__26210;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__25905__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq26207){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq26207));
});
...
var vec__26214 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var seq__26215 = cljs.core.seq.call(null,vec__26214);
var first__26216 = cljs.core.first.call(null,seq__26215);
var seq__26215__$1 = cljs.core.next.call(null,seq__26215);
var first_word = first__26216;
var words = seq__26215__$1;
...
var G__26218 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__26218,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys);
} else {
return G__26218;
}
} else {
...
return clojure.string.join.call(null," ",cljs.core.flatten.call(null,cljs.core.map.call(null,(function (p1__26219_SHARP_){
if(typeof p1__26219_SHARP_ === 'string'){
return p1__26219_SHARP_;
} else {
return cljs.core.seq.call(null,p1__26219_SHARP_);
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__24822__auto__ = x__$1.hasDomain();
...
//# sourceMappingURL=util.js.map?rel=1482768534686