...
if(((cljs.core.set_QMARK_.call(null,class$__$1)) || (cljs.core.sequential_QMARK_.call(null,class$__$1))) && (cljs.core.every_QMARK_.call(null,(function (p1__26222_SHARP_){
return ((p1__26222_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__26222_SHARP_ === 'string');
}),class$__$1))){
...
return cljs.core.update_in.call(null,G__26224,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__26224;
}
});
...
var len__25897__auto___26227 = arguments.length;
var i__25898__auto___26228 = (0);
while(true){
if((i__25898__auto___26228 < len__25897__auto___26227)){
args__25904__auto__.push((arguments[i__25898__auto___26228]));

var G__26229 = (i__25898__auto___26228 + (1));
i__25898__auto___26228 = G__26229;
continue;
} else {
}
break;
...
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__25905__auto__);
});
...
var G__26226 = cljs.core.apply.call(null,cljs.core.merge,maps__$1);
if(!(cljs.core.empty_QMARK_.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__26226,new cljs.core.Keyword(null,"class","class",-2030961996),classes__$1);
} else {
return G__26226;
}
});
...
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq26225){
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq26225));
});
...
var vec__26235 = ((cljs.core.empty_QMARK_.call(null,matches))?(function(){throw cljs.core.ex_info.call(null,[cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst.call(null,matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,matches),cljs.core.rest.call(null,matches)], null)
));
var tag_name = cljs.core.nth.call(null,vec__26235,(0),null);
var names = cljs.core.nth.call(null,vec__26235,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__26235,tag_name,names){
return (function (p1__26230_SHARP_){
return cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__26230_SHARP_));
});})(matches,vec__26235,tag_name,names))
,names))),cljs.core.vec.call(null,cljs.core.map.call(null,sablono.normalize.strip_css,cljs.core.filter.call(null,((function (matches,vec__26235,tag_name,names){
return (function (p1__26231_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__26231_SHARP_));
});})(matches,vec__26235,tag_name,names))
,names)))], null);
});
/**
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__26238){
var vec__26245 = p__26238;
...
var vec__26248 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__26248,(0),null);
var id = cljs.core.nth.call(null,vec__26248,(1),null);
var class$ = cljs.core.nth.call(null,vec__26248,(2),null);
...
//# sourceMappingURL=normalize.js.map?rel=1482768534818